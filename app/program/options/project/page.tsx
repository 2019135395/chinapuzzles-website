      ...
      <div ref={ctaRef} className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 md:py-28">
        <div className={`transition-all duration-1000 ease-out ${
          ...
          <a
            ...
            // 修改点：负 margin 抵消左侧 padding，宽度固定为 300px
            className="inline-flex items-center justify-center w-[300px] bg-[#B41615] text-white font-semibold py-4 px-10 rounded-sm hover:bg-[#8a0f0f] transition-colors -ml-4 sm:-ml-6 lg:-ml-8"
          >
            Send Inquiry →
          </a>
        </div>
