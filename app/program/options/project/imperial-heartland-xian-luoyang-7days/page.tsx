...
const ScheduleCard = ({ item, isVisible, delay }) => {
   useEffect(() => {
    document.title = "The Imperial Heartland: Ancient Capitals from Xi'an to Luoyang | China Puzzles";
  }, []);
...
const OverView = () => {
  ...
  const navItems = [
    ...
    { label: "DAY 01", id: "01", city: "Xi'an" },
    { label: "DAY 02", id: "02", city: "Xi'an" },
    { label: "DAY 03", id: "03", city: "Luoyang" },
    { label: "DAY 04", id: "04", city: "Luoyang" },
    { label: "DAY 05", id: "05", city: "Luoyang" },
  ...
  const scheduleData = [
    {
      ...
      events: [
        { time: "PRE-DAY", desc: "Welcome Dinner & Ice-Breaking (Dumpling Banquet)" }
      ]
    },
    {
      day: "01",
      ...
      events: [
        { time: "08:30-12:30", desc: "Terracotta Warriors" },
        { time: "12:30-13:30", desc: "Lunch" },
        { time: "14:30-17:00", desc: "Ancient City Wall Cycling" },
        { time: "19:00-21:00", desc: "Muslim Quarter Night Food Walk" }
      ]
    },
    {
      day: "02",
      label: "DAY 02",
      title: "Xi'an: Business & Innovation",
      events: [
        { time: "10:00-12:00", desc: "Company Visit 1" },
        { time: "14:00-16:00", desc: "Guest Speaker & Mingling Time" },
        { time: "18:00-20:00", desc: "Big Wild Goose Pagoda & Datang Everbright City" },
        { time: "20:30-22:00", desc: "Tang Dynasty Music & Dance Show" }
      ]
    },
    {
      day: "03",
      label: "DAY 03",
      title: "Xi'an to Luoyang",
      events: [
        { time: "09:00-10:30", desc: "High-speed Train to Luoyang" },
        { time: "12:00-16:00", desc: "Longmen Grottoes" },
        { time: "17:00-19:00", desc: "Luoyang Old Town & Water Banquet Dinner" }
      ]
    },
    {
      day: "04",
      label: "DAY 04",
      title: "Luoyang: Shaolin & Martial Arts",
      events: [
        { time: "08:30-14:00", desc: "Shaolin Temple & Kung Fu Monastery Experience (Dengfeng, Lunch on your own)" },
        { time: "15:00-17:00", desc: "White Horse Temple" },
        { time: "18:00-20:00", desc: "Cultural Experience: Chinese Massage / Foot Massage" }
      ]
    },
    {
      day: "05",
      label: "DAY 05",
      title: "Luoyang: Business & Heritage",
      events: [
        { time: "09:00-11:30", desc: "Company Visit 2 & Guest Lecture" },
        { time: "12:00-13:00", desc: "Lunch" },
        { time: "14:00-16:00", desc: "Sui-Tang Luoyang City Ruins & Museum" },
        { time: "17:00-20:00", desc: "Reflection Roundtable & Farewell Dinner" }
      ]
    },
    {
      day: "06",
  ...
  return (
    <div className="bg-white w-full max-w-full overflow-x-hidden">
      ...
      <div ref={heroRef} className="relative w-full overflow-hidden">
        <div className={`w-full h-[300px] sm:h-[400px] md:h-[480px] bg-cover bg-center transition-all duration-1000 ease-out ${isHeroVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-105'}`} style={{ backgroundImage: "url('https://erp.oxbridgejq.com/assets/uploads/chinapuzzles/images/3799c14eb459b7365f1a9df40ce7dae372dedad1.png')" }}></div>
        ...
        <div className={`absolute left-0 bottom-0 w-full transition-all duration-1000 ease-out delay-300 ${isHeroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pb-10 md:pb-16 w-full">
            <p className="text-xs font-bold tracking-widest text-white/80 uppercase mb-4">Program 05</p>
            {/* ✅ 换成 Libre Bodoni 字体 */}
            <h1 className={`${libreBodoni.className} text-3xl sm:text-4xl md:text-5xl text-white tracking-tight mb-4 md:mb-6`}>The Imperial Heartland: Ancient Capitals from Xi'an to Luoyang</h1>
            <div className="flex flex-wrap gap-y-2 gap-x-2 text-sm md:text-base font-medium text-white/90 mb-6">
              <span>Xi'an</span><span>·</span><span>Luoyang</span><span>·</span><span>7 Days</span>
            </div>
      ...
      <div ref={overviewRef} className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 mt-16 sm:mt-24 mb-16 sm:mb-20 w-full">
        <div className={`transition-all duration-1000 ease-out ${isOverviewVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
          ...
          <p className="text-sm sm:text-[15px] leading-7 text-neutral-600 max-w-4xl">
            This 7-day program follows China's great dynastic corridor between two ancient capitals, linking sightseeing in Xi'an with the wonders of Luoyang, and weaving in two company visits and lectures. Participants will face the Terracotta Warriors, cycle the ancient city wall, and stand before the Longmen Grottoes and the birthplace of Chinese martial arts at Shaolin Temple.
          </p>
        </div>
      </div>
