        ...
        <div className={`relative w-full h-[360px] md:h-[520px] max-h-[580px] overflow-hidden transition-all duration-1000 ease-out ${isHeroVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-105'}`}>
          <picture>
            ...
            <source
              ...
              srcSet="https://erp.oxbridgejq.com/assets/uploads/chinapuzzles/images/3799c14eb459b7365f1a9df40ce7dae372dedad1.png"
            />
            {/* 移动端 & iPad（<1024px）：使用原图文件名加 -mobile 的图片 */}
            <img
              src="https://erp.oxbridgejq.com/assets/uploads/chinapuzzles/images/3799c14eb459b7365f1a9df40ce7dae372dedad1-mobile.png"
              alt="The Imperial Heartland: Ancient Capitals from Xi'an to Luoyang"
