...
const ScheduleCard = ({ item, isVisible, delay }) => {
   ...
   useEffect(() => {
    document.title = "The North-South Axis: Empire, Pandas, and the Silicon Coast (12Day) | China Puzzles";
  }, []);
  return (
    <div
      id={`day-${item.day}`}
...
const OverView = () => {
  ...
  const navItems = [
    ...
    { label: "DAY 07", id: "07", city: "Chengdu" },
    { label: "DAY 08", id: "08", city: "Shenzhen" },
    { label: "DAY 09", id: "09", city: "Shenzhen" },
    { label: "DAY 10", id: "10", city: "Shenzhen" },
    { label: "DAY 11", id: "11", city: "Shenzhen" }
  ];
  ...
  const scheduleData = [
    ...
    },
    {
      day: "05",
      label: "DAY 05",
      title: "Chengdu: Pandas & Teahouse Life",
      events: [
        { time: "08:00-12:00", desc: "Giant Panda Breeding Research Base" },
        { time: "12:00-13:00", desc: "Lunch" },
        { time: "14:00-16:00", desc: "People's Park Teahouse & Local Life" },
        { time: "18:00-20:00", desc: "Sichuan Hot Pot Dinner" }
      ]
    },
    {
      day: "06",
      label: "DAY 06",
      title: "Chengdu: Business & Innovation",
      events: [
        { time: "10:00-12:00", desc: "Company Visit 2" },
        { time: "14:00-16:00", desc: "Guest Speaker & Mingling Time" },
        { time: "18:00-21:00", desc: "Chunxi Road Evening Walk & Local Bar" }
      ]
    },
    {
      day: "07",
    ...
    },
    {
      day: "10",
      label: "DAY 10",
      title: "Shenzhen: Tech & Lingnan Culture",
      events: [
        { time: "09:00-12:00", desc: "Company Visit 4" },
        { time: "12:00-13:00", desc: "Lunch" },
        { time: "14:00-17:00", desc: "Cultural Experience: Dafen Oil Painting Village & Lingnan Craft" },
        { time: "19:00-21:00", desc: "Night Market & Street Food" }
      ]
    },
    {
      day: "11",
      label: "DAY 11",
      title: "Shenzhen: Farewell & Departure",
      events: [
        { time: "09:00-11:00", desc: "Reflection Roundtable & Program Wrap-up" },
        { time: "12:00-13:00", desc: "Lunch" },
        { time: "14:00-16:00", desc: "Free Time / Coastal Park Walk" },
  ...
  return (
    <div className="bg-white w-full max-w-full overflow-x-hidden">
      ...
      <div ref={heroRef} className="relative w-full overflow-hidden">
        <div className={`w-full h-[300px] sm:h-[400px] md:h-[480px] bg-cover bg-center transition-all duration-1000 ease-out ${isHeroVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-105'}`} style={{ backgroundImage: "url('https://erp.oxbridgejq.com/assets/uploads/chinapuzzles/images/45ac5534ebb920d6f2e63f6a806034037a672d091.png')" }}></div>
        ...
        <div className={`absolute left-0 bottom-0 w-full transition-all duration-1000 ease-out delay-300 ${isHeroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pb-10 md:pb-16 w-full">
            <p className="text-xs font-bold tracking-widest text-white/80 uppercase mb-4">Program 03</p>
            {/* ✅ 换成 Libre Bodoni 字体 */}
            ...
            <div className="flex flex-wrap gap-y-2 gap-x-2 text-sm md:text-base font-medium text-white/90 mb-6">
              <span>Beijing</span><span>·</span><span>Chengdu</span><span>·</span><span>Shenzhen</span><span>·</span><span>12 Days</span>
            </div>
