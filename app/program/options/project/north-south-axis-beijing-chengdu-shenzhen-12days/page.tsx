        ...
        <div className={`relative w-full h-[360px] md:h-[520px] max-h-[580px] overflow-hidden transition-all duration-1000 ease-out ${isHeroVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-105'}`}>
          <picture>
            ...
            <source
              ...
              srcSet="https://erp.oxbridgejq.com/assets/uploads/chinapuzzles/images/45ac5534ebb920d6f2e63f6a806034037a672d091.png"
            />
            {/* 移动端 & iPad（<1024px）：使用原图文件名加 -mobile 的图片 */}
            <img
              src="https://erp.oxbridgejq.com/assets/uploads/chinapuzzles/images/45ac5534ebb920d6f2e63f6a806034037a672d091-mobile.png"
