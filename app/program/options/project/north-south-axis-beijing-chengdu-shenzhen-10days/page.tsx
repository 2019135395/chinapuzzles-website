...
const ScheduleCard = ({ item, isVisible, delay }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative mt-8 pt-4 border-t border-neutral-100">
        <div className="grid grid-cols-3 gap-4">
          {visibleImages.map((img, imgIdx) => (
            <div key={imgIdx} className="h-28 md:h-36 overflow-hidden rounded-lg">
              <img
                src={img}
        ...
        {hasPrev && (
          <button onClick={() => setImgOffset(imgOffset - 1)} className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/20 hover:bg-black/40 text-white rounded-full w-10 h-10 flex items-center justify-center backdrop-blur-sm z-10 transition-colors text-xl font-bold">←</button>
        )}
        {hasNext && (
          <button onClick={() => setImgOffset(imgOffset + 1)} className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/20 hover:bg-black/40 text-white rounded-full w-10 h-10 flex items-center justify-center backdrop-blur-sm z-10 transition-colors text-xl font-bold">→</button>
        )}
      </div>
    </div>
  );
...
const OverView = () => {
  ...
  const navItems = [
    ...
    { label: "DAY 04", id: "04", city: "Chengdu" },
    { label: "DAY 05", id: "05", city: "Chengdu" },
    { label: "DAY 06", id: "06", city: "Chengdu" },
    { label: "DAY 07", id: "07", city: "Shenzhen" },
    { label: "DAY 08", id: "08", city: "Shenzhen" },
    { label: "DAY 09", id: "09", city: "Shenzhen" }
  ];
  ...
  const scheduleData = [
    {
      ...
      events: [
        { time: "PRE-DAY", desc: "Welcome Dinner & Ice-Breaking (Peking Duck)" }
      ]
    },
    {
      day: "01",
      label: "DAY 01",
      title: "Beijing: Imperial Grandeur",
      events: [
        { time: "08:00-12:00", desc: "Forbidden City" },
        { time: "12:00-13:00", desc: "Lunch" },
        { time: "14:00-16:00", desc: "Temple of Heaven" },
        { time: "17:00-19:00", desc: "Qianmen Street & Dashilan" },
        { time: "19:30-21:30", desc: "Beijing Hot Pot Dinner" }
      ]
    },
    {
      day: "02",
      label: "DAY 02",
      title: "Beijing: Business & Innovation",
      events: [
        { time: "10:00-12:00", desc: "Company Visit 1" },
        { time: "14:00-16:00", desc: "Guest Speaker & Mingling Time" },
        { time: "18:00-21:00", desc: "Houhai Bar Street & Lake Walk" }
      ]
    },
    {
      day: "03",
      label: "DAY 03",
      title: "Beijing: The Great Wall & Martial Arts",
      events: [
        { time: "08:00-16:00", desc: "Mutianyu Great Wall (Lunch on your own)" },
        { time: "17:00-19:00", desc: "Cultural Experience: Chinese Kung Fu Show & Hands-on Class" },
        { time: "19:30-21:30", desc: "Hutong Dinner & Night Walk" }
      ]
    },
    {
      day: "04",
      label: "DAY 04",
      title: "Beijing to Chengdu",
      events: [
        { time: "09:00-12:30", desc: "Flight to Chengdu (Lunch on your own)" },
        { time: "14:30-17:00", desc: "Kuanzhai Alley & Local Snacks" },
        { time: "17:30-18:30", desc: "People's Park Teahouse & Local Life" },
        { time: "19:30-21:00", desc: "Sichuan Opera Face-Changing Show" }
      ]
    },
    {
      day: "05",
      label: "DAY 05",
      title: "Chengdu: Pandas & Business",
      events: [
        { time: "08:00-12:00", desc: "Giant Panda Breeding Research Base" },
        { time: "12:00-13:00", desc: "Lunch" },
        { time: "14:00-16:00", desc: "Company Visit 2" },
        { time: "16:30-18:00", desc: "Guest Speaker & Mingling Time" },
        { time: "18:30-20:30", desc: "Sichuan Hotpot Dinner & Chunxi Road Evening Walk" }
      ]
    },
    {
      day: "06",
      label: "DAY 06",
      title: "Chengdu: Nature & Wellness",
      events: [
        { time: "09:00-15:00", desc: "Dujiangyan Irrigation System & Mount Qingcheng (Lunch on your own)" },
        { time: "16:30-18:30", desc: "Cultural Experience: Traditional Chinese Medicine & Herbal Market" },
        { time: "19:00-21:00", desc: "Chinese Massage & Dinner" }
      ]
    },
    {
      day: "07",
      label: "DAY 07",
      title: "Chengdu to Shenzhen",
      events: [
        { time: "09:00-12:00", desc: "Flight to Shenzhen (Lunch on your own)" },
        { time: "14:00-16:00", desc: "Huaqiangbei Electronics Market" },
        { time: "17:00-19:00", desc: "OCT Loft Art District" },
        { time: "19:30-21:00", desc: "Seafood Dinner at Sea World" }
      ]
    },
    {
      day: "08",
      label: "DAY 08",
      title: "Shenzhen: Business & Innovation",
      events: [
        { time: "10:00-12:00", desc: "Company Visit 3" },
        { time: "12:00-13:00", desc: "Lunch" },
        { time: "14:00-16:00", desc: "Guest Speaker & Mingling Time" },
        { time: "18:00-21:00", desc: "Ping An Finance Centre Observation Deck & Dinner" }
      ]
    },
    {
      day: "09",
      label: "DAY 09",
      title: "Shenzhen: Tech, Culture & Farewell",
      events: [
        { time: "09:00-12:00", desc: "Company Visit 4" },
        { time: "12:00-13:00", desc: "Lunch" },
        { time: "14:00-17:00", desc: "Cultural Experience: Dafen Oil Painting Village & Lingnan Craft" },
        { time: "17:30-18:30", desc: "Night Market & Street Food" },
        { time: "19:00-21:00", desc: "Reflection Roundtable & Farewell Dinner" },
        { time: "Next Morning", desc: "Check-out & Departure" }
      ]
    }
  ];
      ...
      <div ref={heroRef} className="relative w-full overflow-hidden">
        ...
        <div className={`relative w-full h-[360px] md:h-[520px] max-h-[580px] overflow-hidden transition-all duration-1000 ease-out ${isHeroVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-105'}`}>
          <picture>
            ...
            <source
              ...
              srcSet="https://erp.oxbridgejq.com/assets/uploads/chinapuzzles/images/721f3d0db21f0266bb1bd951a583df16d455ff09.png"
            />
            {/* 移动端 & iPad（<1024px）：使用原图文件名加 -mobile 的图片 */}
            <img
              src="https://erp.oxbridgejq.com/assets/uploads/chinapuzzles/images/721f3d0db21f0266bb1bd951a583df16d455ff09-mobile.png"
        ...
        <div className={`absolute left-0 bottom-0 w-full transition-all duration-1000 ease-out delay-300 ${isHeroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pb-10 md:pb-16 w-full">
            <p className="text-xs font-bold tracking-widest text-white/80 uppercase mb-4">Product 01</p>
            <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl text-white tracking-tight mb-4 md:mb-6">The North-South Axis: Empire, Pandas, and the Silicon Coast</h1>
            <div className="flex flex-wrap gap-y-2 gap-x-2 text-sm md:text-base font-medium text-white/90 mb-6">
              <span>Beijing</span><span>·</span><span>Chengdu</span><span>·</span><span>Shenzhen</span><span>·</span><span>10 Days</span>
            </div>
      ...
      <div ref={overviewRef} className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 mt-16 sm:mt-24 mb-16 sm:mb-20 w-full">
        <div className={`transition-all duration-1000 ease-out ${isOverviewVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
          ...
          <p className="text-sm sm:text-[15px] leading-7 text-neutral-600 max-w-4xl">
            This 10-day program is designed for you to trace China's arc from the imperial north to the innovation south. Participants will walk through the Forbidden City and onto the Great Wall, meet giant pandas in Chengdu, and end in Shenzhen — the engine room of China's digital economy. Company visits span technology, new energy, and hardware, with martial arts, Sichuan opera, and traditional Chinese wellness woven in.
          </p>
        </div>
      </div>
