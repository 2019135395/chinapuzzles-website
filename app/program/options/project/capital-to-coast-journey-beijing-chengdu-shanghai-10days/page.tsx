  ...
  return (
    <div className="bg-white  w-full max-w-full overflow-x-hidden">
      ...
      <div ref={heroRef} className="relative w-full overflow-hidden">
        <div className={`w-full h-[300px] sm:h-[400px] md:h-[480px] bg-cover bg-center transition-all duration-1000 ease-out ${isHeroVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-105'}`} style={{ backgroundImage: "url('/images/c07896ff132e866a2d6cd1a018353d0da312c5a1.png')" }}></div>
