...
const ScheduleCard = ({ item, isVisible, delay }) => {
   ...
   useEffect(() => {
    document.title = "The Capital-to-Coast Journey: Heritage, Panda Country, and the Global Metropolis (12Day) | China Puzzles";
  }, []);
...
const OverView = () => {
  ...
  const navItems = [
    ...
    { label: "DAY 08", id: "08", city: "Chengdu" },
  ...
  const scheduleData = [
    ...
    },
    {
      ...
      events: [
        ...
        { time: "18:00-21:00", desc: "Sichuan Hot Pot Dinner" }
      ]
    },
    {
      day: "06",
      ...
      events: [
        ...
        { time: "14:00-16:00", desc: "Guest Speaker & Mingling Time" },
        { time: "18:00-21:00", desc: "Chunxi Road & Taikoo Li Evening Walk" }
      ]
    },
    {
      day: "07",
    ...
    },
    {
      ...
      events: [
        ...
        { time: "18:00-20:00", desc: "The Bund Night Walk & Nanjing Road" }
      ]
    },
    {
      day: "09",
    ...
    },
    {
      day: "10",
      label: "DAY 10",
      title: "Shanghai: Innovation & Culture",
      events: [
        { time: "10:00-12:00", desc: "Company Visit 4" },
        { time: "12:00-13:00", desc: "Lunch" },
        { time: "14:00-17:00", desc: "Cultural Experience: Chinese Tea Ceremony & Calligraphy" },
        { time: "18:00-20:00", desc: "Tianzifang & Xintiandi City Walk" }
      ]
    },
    {
      day: "11",
      label: "DAY 11",
      title: "Shanghai: Farewell & Departure",
      events: [
        { time: "09:00-11:00", desc: "Jing'an Temple & Free Time" },
        { time: "12:00-13:00", desc: "Lunch" },
        { time: "15:00-17:00", desc: "Reflection Roundtable & Program Wrap-up" },
  ...
  return (
    <div className="bg-white w-full max-w-full overflow-x-hidden">
      ...
      <div ref={heroRef} className="relative w-full overflow-hidden">
        <div className={`w-full h-[300px] sm:h-[400px] md:h-[480px] bg-cover bg-center transition-all duration-1000 ease-out ${isHeroVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-105'}`} style={{ backgroundImage: "url('https://erp.oxbridgejq.com/assets/uploads/chinapuzzles/images/8e4a113c8874aae7793215d567b5e73352aa8b2a.png')" }}></div>
        ...
        <div className={`absolute left-0 bottom-0 w-full transition-all duration-1000 ease-out delay-300 ${isHeroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pb-10 md:pb-16 w-full">
            <p className="text-xs font-bold tracking-widest text-white/80 uppercase mb-4">Program 04</p>
            {/* ✅ 换成 Libre Bodoni 字体 */}
            ...
            <div className="flex flex-wrap gap-y-2 gap-x-2 text-sm md:text-base font-medium text-white/90 mb-6">
              <span>Beijing</span><span>·</span><span>Chengdu</span><span>·</span><span>Shanghai</span><span>·</span><span>12 Days</span>
            </div>
